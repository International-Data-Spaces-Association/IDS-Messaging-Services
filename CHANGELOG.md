...
- Dataspace Connector effort estimation: In the ConnectorService, the ConnectorMissingCertExtensionException must no longer be caught because it is no longer thrown.
