...
public interface IDSBrokerService {
     ...
     */
    Response removeResourceFromBroker( String brokerURI, Resource resource )
     ...
     * @throws IOException if the built message could not be serialized
     */
    Response updateResourceAtBroker( String brokerURI, Resource resource )
            throws IOException, DapsTokenManagerException;
     ...
     */
    Response unregisterAtBroker( String brokerURI ) throws IOException, DapsTokenManagerException;
     ...
     * @throws IOException if the built message could not be serialized
     */
    Response queryBroker( String brokerURI, String query, QueryLanguage queryLanguage, QueryScope queryScope,
