...
public class MessageBuilder {
     ...
     */
    public static String buildResourceUnavailableMessage( DynamicAttributeToken securityToken,
     ...
     * @throws IOException when the message cannot be serialized properly
     */
    public static String buildResourceUpdateMessage( DynamicAttributeToken securityToken, String infoModelVersion,
     ...
     * @throws IOException when the message cannot be serialized properly
     */
    public static String buildUnavailableMessage( DynamicAttributeToken securityToken, String infoModelVersion,
     ...
     * @throws IOException when the message cannot be serialized properly
     */
    public static String buildUpdateMessage( DynamicAttributeToken securityToken, String infoModelVersion,
                                             URI connectorID ) throws IOException {
     ...
     * @throws IOException when the message cannot be serialized properly
     */
    public static String buildQueryMessage( DynamicAttributeToken securityToken, String infoModelVersion,
