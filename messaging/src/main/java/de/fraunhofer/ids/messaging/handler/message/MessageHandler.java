...
public interface MessageHandler<T extends Message> {
     ...
     *
     * @param queryHeader header part of the incoming
     *                    Message (an instance of RequestMessage)
     * @param payload     payload of the Message
     *             (as MessagePayload, access with getUnderlyingInputStream())
     * @return an instance of MessageResponse
     * (BodyResponse, ErrorResponse,...)
     * @throws MessageHandlerException if an error occurs while
