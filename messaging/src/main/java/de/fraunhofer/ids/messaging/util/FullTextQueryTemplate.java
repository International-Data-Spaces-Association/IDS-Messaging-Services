...
public final class FullTextQueryTemplate {
    ...
    public static final String FULL_TEXT_QUERY = "PREFIX ids: <https://w3id.org/idsa/core/>\n"
          ...
          + "      BIND(ids:BaseConnector AS ?type) # binds are directly to cover \"x a A, B .\" cases.\n"
          ...
          + "\n"
          + "    {\n"
          + "      ?internalUri owl:sameAs ?uri . # if a renaming happened, show the original URI.\n"
          + "    } UNION {\n"
          + "      FILTER(NOT EXISTS { ?internalUri owl:sameAs ?uri } ) # maybe this call is expensive.\n"
