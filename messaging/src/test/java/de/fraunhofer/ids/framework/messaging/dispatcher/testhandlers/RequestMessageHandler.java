...
public class RequestMessageHandler implements MessageHandler<RequestMessageImpl> {
    @Override
    public MessageResponse handleMessage(RequestMessageImpl queryHeader, MessagePayload payload) throws MessageHandlerException {
        return ErrorResponse.withDefaultHeader(RejectionReason.BAD_PARAMETERS, "request", URI.create("http://uri"),"4.0");
    }
}
